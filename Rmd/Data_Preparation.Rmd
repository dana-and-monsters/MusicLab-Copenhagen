...
## DSQd052 (the pt did not fil one question and the RA missed this and did not write an NA)
...
### check also for response bias/pts who answered the same number even on opposite items
"straight lining"
...
##### Try again with removing EC_6: I am often quite touched by things that I see happen.
```{r}
...
# Save prepared data
```{r}
saveRDS(df.full, "Prepared_Data.Rda")
```
